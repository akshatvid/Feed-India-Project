const express = require("express"),
  ...
  Information = require("./models/information.model");
...
app.get("/inform", function (req, res) {
  res.sendFile("views/inform.html", {
    root: path.join(__dirname, "./"),
  });
});
              ...
              try {
                Information.find({}, function (err, information) {
                  try {
                    ...
                    { food: food, money: money, feedback: feedback, information: information },
                  );
                  }
                  catch (err) {
                  console.log(err);
...
app.post("/inform", function (req, res) {
  Information.create(req.body.user, function (err, user) {
    try {
      console.log(user);
      res.redirect("/thank.html");
    } catch (err) {
